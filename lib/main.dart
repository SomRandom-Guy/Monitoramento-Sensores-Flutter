...
class VerdeSmartApp extends StatelessWidget {
 ...
 title: 'VerdeSmart',
 theme: ThemeData(
 colorScheme: ColorScheme.fromSeed(seedColor: const Color(0x0000FF)),
 useMaterial3: true,
 ),
...
class DashboardScreen extends StatelessWidget {
 ...
 final normal = areas.where((a) => a.status == StatusVegetacao.normal).length;
 final atencao = areas.where((a) => a.status == StatusVegetacao.atencao).length;
 final urgentes = areas.where((a) => a.status == StatusVegetacao.urgente).length;
 ...
 '$total Áreas | $normal Normal | $atencao Atenção | $urgentes Urgente(s)',
